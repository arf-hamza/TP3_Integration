...
export default function ModalConfirmation(props : ModalConfirmationProp) {
    ...
    const [btnCancelLabel, setBtnCancelLabel] = useState( t('modalConfirmation.btnCancelText') );
    ...
    >
        <Box className={Style.modal_confirmation}>
                ...
                <Box className={Style.modal_footer}>
                    <Button className={Style.modal_btn_confirm} onClick={handleConfirm}> { btnConfirmationLabel }</Button>
                    <Button className={Style.modal_btn_cancel} onClick={handleClose}>{ btnCancelLabel }</Button>
                </Box>
            </Box>
        </Modal>
  );
