...
return (
    <>
        ...
        spacing={2}>
            ...
            <TextField fullWidth /*defaultValue={props.name}*/ id="nom-produit" label="Nom du produit" variant="outlined" sx={inputStyle} required />
            <TextField fullWidth /*defaultValue={props.price}*/ id="prix-produit" label="Prix du produit" variant="outlined" sx={inputStyle} required />
